...
AddEventHandler('esx_ambulancejob:success', function()
  ...
  local total2		   = math.random(Config.NPCJobEarnings.min, Config.NPCJobEarnings.max);
  ...
  TriggerClientEvent('esx:showNotification', xPlayer.source, _U('have_earned') .. total2)
  TriggerClientEvent('esx:showNotification', xPlayer.source, _U('comp_earned') .. total)
